#
#  Be sure to run `pod spec lint watch2earn-applesdk.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "asad926" => "asad@edgevideo.com" }
  # Or just: spec.author    = "asad926"
  # spec.authors            = { "asad926" => "asad@edgevideo.com" }
  # spec.social_media_url   = "https://twitter.com/asad926"
